...
## About Me
Hi, I'm **Mohan Elapolu**, A computational scientist and a professional researcher with over 10 years of experience integrating predictive physics-based modeling (Finite Element Analysis (FEA), Molecular Dynamics (MD)) with data-driven methods in Machine Learning, Natural Language Processing, and Generative AI.

My expertise spans Large Language Models (LLMs), Knowledge Graphs, Retrieval-Augmented Generation (RAG), autonomous AI agents, and physics-guided machine learning for intelligent simulation and decision-making.

I use mathematical tools and computer programs to address and solve real-world problems. We model, visualize, and simulate various complex experiments to understand material system behavior and answer open research questions, often saving resources and pushing frontiers of research.
**Research Interests:**
...
- Mohan S R Elapolu, Mahmoud Dinar, and Alireza Tabarraei, FiGNNet: A Fracture-informed Graph Transformer-Attention Neural Network for Simulating Crack Propagation, Computational Material Science (2025) [Publication Link](http://dx.doi.org/10.2139/ssrn.5713427)
...
### Physics-based Predictive Analysis
